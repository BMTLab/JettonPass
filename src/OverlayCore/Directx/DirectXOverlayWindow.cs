...
namespace JettonPass.OverlayCore.Directx
{
    ...
    public class DirectXOverlayWindow
    {
        ...
        public DirectXOverlayWindow(bool limitFps = true)
        {
            ...
            X = 0;
            Y = 0;
            Width = GetSystemMetrics(WindowConstants.SmCxScreen);
            Height = GetSystemMetrics(WindowConstants.SmCyScreen);
        ...
        public DirectXOverlayWindow(IntPtr parent, bool limitFps = true)
        {
            ...
            GetWindowRect(parent, out var bounds);
        ...
        /// </value>
        public bool ParentWindowExists { get; }
        ...
        private bool CreateWindow()
        {
            ...
            SetLayeredWindowAttributes(Handle, 0, 255, WindowConstants.LwaAlpha);
        ...
        public void Update()
        {
            ...
            GetWindowRect(ParentWindow, out var bounds);
        ...
        public void SetPos(int x, int y)
        {
            ...
            SetWindowPos(Handle, WindowConstants.HwndTopmost, X, Y, Width, Height, 0);
        ...
        public void Show()
        {
            ...
            ShowWindow(Handle, WindowConstants.SwShow);
            IsVisible = true;
        ...
        public void Hide()
        {
            ...
            ShowWindow(Handle, WindowConstants.SwHide);
            IsVisible = false;
        }
    }
}